...
export default function Legend() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-30 flex flex-col gap-1 rounded-lg bg-bg-panel/90 backdrop-blur-sm border border-border px-3 py-2 text-xs">
      ...
      <div className="mt-1 text-text-secondary/60">{t('legendHint')}</div>
    </div>
  )
}
